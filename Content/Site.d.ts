...
declare module Site {
    ...
    module SpeechSynthesis {
        module Utils {
            var ToArray : {
                <_M1>(a: __ABBREV.__Html5.ArrayLike<_M1>): _M1[];
            };
        }
        var Main : {
            (e: __ABBREV.__Dom.Element): void;
        };
        var MaxConfidence : {
            (): {
                (x: __ABBREV.__Html5.SpeechRecognitionAlternative[]): __ABBREV.__Html5.SpeechRecognitionAlternative;
            };
        };
        var Sample : {
    ...
    module SpeechUtterance {
        var MkField : {
            (sp: __ABBREV.__Html5.SpeechSynthesis, u: __ABBREV.__Html5.SpeechSynthesisUtterance): __ABBREV.__List.T<__ABBREV.__Html.Element>;
        };
        var Main : {
            (e: __ABBREV.__Dom.Element): void;
        };
